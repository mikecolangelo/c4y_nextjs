...
export function GridVehicleCard({
  ...
  return (
    ...
    >
      <CardContent
        className={`flex flex-col ${spacing.gap.small} ${spacing.card.padding} p-4 relative`}
      >
        {isSelectMode && (
        ...
        <div className={`flex flex-col ${spacing.gap.small}`}>
          ...
          <p
            className={`${typography.body.small} text-muted-foreground leading-normal line-clamp-1`}
          >
            VIN: {vehicle.vin}
          </p>
